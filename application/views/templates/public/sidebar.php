    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php print base_url('index.php/siswa/'); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php print base_url('index.php/guru/'); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php print base_url('index.php/mapel/'); ?>" class="nav-link">
